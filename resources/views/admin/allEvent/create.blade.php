    ...
    <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="{{ URL('admin/allEvent') }}" method="POST">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            Event Name:<input type="text" name="allEventName" class="form-control" required="required">
            <br>
            Time Start:
            <div class="input-group date form_datetimeStart col-md-5" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
                    <input class="form-control" name="allDayEventTime" size="16" type="text" value="" readonly required="required">
            ...
            <div class="input-group date form_datetimeEnd col-md-5" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
                    <input class="form-control" name="allDayEventTimeEnd" size="16" type="text" value="" readonly required="required">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
					<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>  
                </div> 
                <br>
            Image Link:<input type="text" name="allEventImgLink" class="form-control" required="required">
            <br>
